...
// tratamos o valor como horário local de Brasília. Para não sofrer com o fuso do
// servidor onde o Node roda (ex.: um host de deploy em UTC), calculamos o "agora" já
// convertido para o fuso America/Sao_Paulo e comparamos as strings diretamente
// (comparação lexicográfica funciona porque ambas seguem o formato AAAA-MM-DDTHH:mm:ss).
...
module.exports = { agoraNoBrasil, classificarSituacao };
